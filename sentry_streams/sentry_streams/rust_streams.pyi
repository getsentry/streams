...
class PyKafkaConsumerConfig:
    ...
    @property
    def auto_offset_reset(self) -> InitialOffset: ...
    @property
    def strict_offset_reset(self) -> bool: ...
    @property
...
class RuntimeOperator:
    ...
    def DevNullSink(
        ...
        average_sleep_time_ms: float | None = None,
        max_sleep_time_ms: float | None = None,
    ) -> Self: ...
    @classmethod
    def Router(
        cls,
...
class PullOperator:
    @classmethod
    def HeaderFilter(cls, header_name: str, expected_value: int) -> Self: ...
    @classmethod
    def Batch(cls, max_batch_size: int) -> Self: ...
    @classmethod
    def PyCallable(cls, callable: Callable[..., Any], name: str, schema: str) -> Self: ...
    @classmethod
    def GcsSink(cls, bucket: str, object_generator: Callable[[], str]) -> Self: ...
    @classmethod
    def MockSink(cls) -> Self: ...

class PyTestMessage:
    def __init__(self, payload: bytes, headers: Mapping[str, bytes] | None = None) -> None: ...

class PullSourceConfig:
    @classmethod
    def Kafka(cls, config: PyKafkaConsumerConfig, topic: str) -> Self: ...
    @classmethod
    def Test(cls, messages: Sequence[PyTestMessage]) -> Self: ...
...
class PullConsumer:
    def __init__(
        ...
        sink: PullOperator | None = None,
    ) -> None: ...
    def run(self) -> None: ...
    def get_mock_sink_results(self) -> list[bytes]: ...
